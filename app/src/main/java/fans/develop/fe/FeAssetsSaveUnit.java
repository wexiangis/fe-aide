...
class FeAssetsSaveUnit {
    ...
    public class Unit extends FeReaderFile {
        ...
        public int getRecord(int line) {
            return getInt(line, 9);
        }

        public int getExp(int line) {
        ...
        public void setAbility(int line, int ability) {
            setValue(ability, line, 1);
        }

        public void setGrow(int line, int grow) {
            setValue(grow, line, 2);
        }
        ...
        public void setSpecial(int line, int special) {
            setValue(special, line, 4);
        }

        public void setLevel(int line, int level) {
            setValue(level, line, 5);
        }

        public void setItem(int line, int item) {
            setValue(item, line, 6);
        }

        public void setCamp(int line, int camp) {
            setValue(camp, line, 7);
        }

        public void setState(int line, int state) {
            setValue(state, line, 8);
        }

        public void setRecord(int line, int record) {
            setValue(record, line, 9);
        }

        public void setExp(int line, int exp) {
            setValue(exp, line, 10);
        }
    ...
    public class Record extends FeReaderFile {
        ...
        public int getWin(int line) {
            return getInt(line, 1);
        }

        public int getDie(int line) {
            return getInt(line, 2);
        }

        public void setRecord(int line, int record) {
            setValue(record, line, 0);
        }

        public void setWin(int line, int win) {
            setValue(win, line, 1);
        }

        public void setDie(int line, int die) {
            setValue(die, line, 2);
        }
