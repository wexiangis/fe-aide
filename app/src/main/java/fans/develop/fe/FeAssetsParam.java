...
public class FeAssetsParam {
    ...
    public class Types extends FeReaderFile {
        ...
        public int getPicture(int line) {
    ...
    public class Items extends FeReaderFile {
        ...
        public int getRange(int line) {
            return getInt(line, 5);
        }

        public int getRangeSpace(int line) {
            return getInt(line, 6);
        }

        public int getWeight(int line) {
            return getInt(line, 7);
        }

        public int getPower(int line) {
            return getInt(line, 8);
        }

        public int getHit(int line) {
            return getInt(line, 9);
        }

        public int getCritical(int line) {
            return getInt(line, 10);
        }

        public int getCapacity(int line) {
            return getInt(line, 11);
        }

        public int getBelongId(int line) {
            return getInt(line, 12);
        }
    ...
    public class SkillLevel extends FeReaderFile {
        public int getE(int line) {
            return getInt(line, 0);
        }

        public int getD(int line) {
            return getInt(line, 1);
        }

        public int getC(int line) {
            return getInt(line, 2);
        }

        public int getB(int line) {
            return getInt(line, 3);
        }

        public int getA(int line) {
            return getInt(line, 4);
        }

        public int getS(int line) {
            return getInt(line, 5);
        }

        public int getSS(int line) {
            return getInt(line, 6);
        }
